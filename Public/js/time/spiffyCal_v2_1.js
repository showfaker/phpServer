...
// GLOBAL variables
var scImgPath = '../Public/js/time/spiffyCal/images/';
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		strOutput += '<table width="185" height="109" style="background-color:#888888" cellspacing="1" cellpadding="2" border="0"><tr>';
