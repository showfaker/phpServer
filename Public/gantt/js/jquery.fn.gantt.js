    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            render: function (element) {
                ...
                element.gantt = $('<div class="fn-gantt gantt" />').append(content);
        ...
        var tools = {
            ...
            getMaxDate: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    $.each(entry.values, function (i, date) {
                        maxDate = maxDate==null || maxDate < tools.dateDeserialize(date.to) ? tools.dateDeserialize(date.to) : maxDate;
                    });
                });
            ...
            getMinDate: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    $.each(entry.values, function (i, date) {
                        minDate = minDate == null || minDate > tools.dateDeserialize(date.from) ? tools.dateDeserialize(date.from) : minDate;
                    });
                });
