...
var $this=$(this);
var op={html5Upload:false,tools:$this.attr("tools")||'full',skin:$this.attr("skin")||'vista',cleanPaste:$this.attr("cleanPaste")||'1'};
...
$("textarea.kindeditor", $p).each(function () {
    $.getScript('../Public/js/editor/kindeditor-min.js', function () {
        ...
        var editor = KindEditor.create('textarea[name="content"]', {
            ...
            fileManagerJson: '../Public/js/editor/php/file_manager_json.php',
...
if(-1!=_lookup.currentGroup.indexOf("e_"))
var strDot="-";
else
...
$input.val(args[key]);
break;}}});},
bringBackanddivide:function(args){
...
//var $rowNum=$('<input type="text" name="dwz_rowNum" class="textInput" style="margin:2px;" value="1" size="2"/>').insertBefore($table); 去掉后面的输入框
var trTm="";
...
break;
case 'readonly':
html='<input type="text" readonly name="'+field.name+'" value="'+field.defaultVal+'" size="'+field.size+'" class="'+field.fieldClass+'" '+attrFrag+'/>';
break;
default:
