...
function makeSelectBox(thisId) {
    var downArrowSrc = "images/bu_down.gif";    //Èý½Ç
    var downArrowSrcWidth = 16;    //¿í
    var optionHeight = 18; // ¸ß
    var optionMaxNum = 7; // 
    ...
    for (var i=0 ; i < obj.options.length ; i++) {
        ...
        newSelect += "            <tr>";
        newSelect += "                <td .style.backgroundColor='#FFBA00';return true;  .style.backgroundColor='FFFFFF';return true; bgcolor=#FFFFFF height='" + optionHeight + "' class='selectBoxOption' onMouseOver=\"this.className='selectBoxOptionOver'\" onMouseOut=\"this.className='selectBoxOption'\" onClick=\"selectThisValue('"+ objId + "'," + i + ",'" + nowValue + "','" + nowText + "')\" style='cursor:hand;' >" + nowText + "</td>";
