<?php
class PlmmyworkAction extends CommonAction {
	//过滤查询字段
	...
	public function index() {
		...
		//$map['timebegin']=array('egt',$timebegin);
		//$map['timeend']=array('elt',$timeend);
		$map['timebegin']=array('elt',$timeend);
		$map['timeend']=array('egt',$timebegin);
		
		$worklist=M("Plmworkassignment")->where($map)->order("create_time asc")->select();
		...
		/*
		$map = $this->_search('Plmworkassignment');
