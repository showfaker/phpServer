<?php
class JypgAction extends CommonAction {			
	//过滤查询字段
	...
	function insert() {
		...
		$model->handlehistory=$info['handlehistory'].$_SESSION['loginUserName']."于".$date."进行可研编制文件上传</br>------------------</br>"; 
		...
		$date=date('m-d H:i');
		$address=$info['title'];
		$data['content']=$_SESSION['loginUserName']."于".$date."提交《".$address."》可研审核，请您进行立项审批。";
		$data['href'] ="index.php?s=Jypgcheck/index";
		$data['taskid'] =$taskid;
		$data['type'] ="Jypgcheck";
